 ...
 * About section.
 *
 * A summary and a portrait, nothing more. The year-by-year timeline that
 * used to live here duplicated the Resume section below it, which carries
 * every role in full — so this is the short version, condensed from
 * Gabriel's own bio.
 */
export const about = {
  eyebrow: "About me",
  ...
  /** Short factual markers, shown beside the portrait. */
  facts: [
    { label: "Based in", value: "São Paulo, Brazil" },
    { label: "Currently", value: "Earned Media Productions" },
    { label: "Focus", value: "UX/UI and website build" },
